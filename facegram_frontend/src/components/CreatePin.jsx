...
const CreatePin = ({user}) => {
  ...
  return (
    <div className='flex flex-col justify-center items-center mt-5 lg:h-4/5'>
      ...
      <div className='flex lg:flex-row flex-col justify-center items-center bg-white lg:w-4/5 w-full'>
            ...
            {!imageAsset ? (
              <label>
                <div className='flex flex-col items-center justify-center h-full'>
                  ...
                  <p className=' text-gray-400 flex-wrap mt-20'>
              ...
              <div className='flex flex-col'>
                ...
                <div className='flex justify-end items-end mt-5'>
                      <button
                        type='button'
                        onClick={savePin}
                        className='bg-[#33ccff] text-white font-bold p-2 rounded-full w-28 outline-none'
                      >
                        Save Pin
                      </button>
                </div>
